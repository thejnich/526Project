...
The server side implementation is based on work done by Kyle Huff \ref{cite:gpgauth}. We took his open source PHP back end, and modified it making it easier to use. We then ported it to other languages to make it easier to adopt.
\subsubsection{Goals}
\subsubsection{PHP}
\subsubsection{Perl}
