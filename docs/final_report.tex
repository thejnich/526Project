...
\begin{description}
	...
	\item[X-GPGAuth-Pubkey-URL:]  URL of the servers public key, used for import into clients local keyring to do server authentication among other things
	\item[X-GPGAuth-Progress:] St ring consisting of stage0/stage1/stage2 used for keeping track of how far along authentication has gone
