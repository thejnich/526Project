...
\begin{itemize}
	\item A single client side public key implementation must be done, most likely in Java-script. Browser extensions may have to be written for seamless login behaviours.
	\item A server side implementation must be done per web service that wants to enable this authentication system. That includes public key retrieval, and a public key implementation. Languages used here include perl, ruby, python, asp, cgi, etc.
\end{itemize}
